...
<html>
	...
	<body>
		...
		<?php
		    ...
		    echo "<div id='results' align='center'><h2><br><br><br>You have correctly answered <br> $totalCorrect / 5 <br>Sanskrit names for yoga positions</h2></div>";
			...
			$sql = "UPDATE yogaTable SET Score='$totalCorrect/5', Date='$t' ORDER BY Date DESC LIMIT 1";
